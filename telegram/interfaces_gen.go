...
func (*AiComposeToneObj) FlagIndex() int {
	return 0
}
...
func (*AiComposeToneDefault) ImplementsAiComposeTone() {}
...
func (*BotInlineMessageRichMessage) CRC() uint32 {
	return 0xa617e7b
}

func (*BotInlineMessageRichMessage) FlagIndex() int {
	return 0
}

func (*BotInlineMessageRichMessage) ImplementsBotInlineMessage() {}
...
func (*ChannelAdminLogEventActionParticipantEditRank) CRC() uint32 {
	return 0x5806b4ec
}

func (*ChannelAdminLogEventActionParticipantEditRank) ImplementsChannelAdminLogEventAction() {}
...
type ChannelParticipantObj struct {
	...
	Rank                  string `tl:"flag:2"` // The participant's tag.
}
...
type ChannelParticipantAdmin struct {
	...
	Rank        string           `tl:"flag:2"` // The participant's tag, defaults to "Admin" if not set.
}
...
type ChannelParticipantCreator struct {
	...
	Rank        string           `tl:"flag:0"` // The participant's tag, defaults to "Owner" if not set.
}
...
type ChannelForbidden struct {
	...
	Monoforum  bool   `tl:"flag:10,encoded_in_bitflags"` // If set, this is a monoforum.
	ID         int64  // Channel ID
...
type ChannelFull struct {
	...
	MainTab                ProfileTab       `tl:"flag2:22"`
	GuardBotID             int64            `tl:"flag2:23"`
}
...
type ChatParticipantObj struct {
	...
	Rank      string `tl:"flag:0"` // The participant's tag.
}
...
func (*ChatParticipantObj) FlagIndex() int {
	return 0
}
...
func (*ChatParticipantAdmin) FlagIndex() int {
	return 0
}
...
func (*ChatParticipantCreator) FlagIndex() int {
	return 0
}
...
type DraftMessageObj struct {
	...
	RichMessage   *RichMessage   `tl:"flag:9"`
}
...
func (*InputAiComposeToneSlug) ImplementsInputAiComposeTone() {}
...
func (*InputBotInlineMessageRichMessage) CRC() uint32 {
	return 0xb43df56c
}

func (*InputBotInlineMessageRichMessage) FlagIndex() int {
	return 0
}

func (*InputBotInlineMessageRichMessage) ImplementsInputBotInlineMessage() {}
...
// Used to pay for login codes, in case of high cost of SMS verification codes for the user's country/provider
type InputInvoicePremiumAuthCode struct {
	Purpose InputStorePaymentPurpose // Must contain an inputStorePaymentAuthCode.
}
...
type InputInvoiceStarGiftAuctionBid struct {
	HideName  bool              `tl:"flag:0,encoded_in_bitflags"` // If set, your name will be hidden if the destination peer decides to display the gift on their profile (they will still see that you sent the gift). Must not be set when updating an existing bid, as the value cannot be changed for existing bids.
	UpdateBid bool              `tl:"flag:2,encoded_in_bitflags"` // Must be set when increasing an already existing bid.
	Peer      InputPeer         `tl:"flag:3"`                     // Identifier of the user or channel (only if channelFull.`stargifts_available` is set) that will receive the gift.
	GiftID    int64             // Identifier of the gift, from starGift.`id`
	BidAmount int64             // Total amount of the bid in Telegram Stars.
	Message   *TextWithEntities `tl:"flag:1"` // Optional message that will be attached with the gift if we end up winning this round: the maximum length for this field is specified in the stargifts_message_length_max client configuration value. Must not be set when updating an existing bid, as the value cannot be changed for existing bids.
}
...
// Used to pay for for the removal of the starGiftAttributeOriginalDetails attribute from a collectible gift
type InputInvoiceStarGiftDropOriginalDetails struct {
	Stargift InputSavedStarGift // The collectible gift whose starGiftAttributeOriginalDetails attribute should be removed.
}
...
type InputPasskeyCredentialPublicKey struct {
	...
	RawID    string               // `rawId` field of a PublicKeyCredential, passed as-is without base64url-decoding when using the JSON representation
...
// WebAuthn authentication response used when logging in with a passkey
type InputPasskeyResponseLogin struct {
	ClientData        *DataJson // Base64url-decoded `clientDataJSON` field of an AuthenticatorAssertionResponse, wrapped in dataJSON
	AuthenticatorData []byte    // Base64url-decoded `authenticatorData` field of an AuthenticatorAssertionResponse
	Signature         []byte    // Base64url-decoded `signature` field of an AuthenticatorAssertionResponse
	UserHandle        string    // Base64url-decoded `userHandle` field of an AuthenticatorAssertionResponse. The user handle specified by the server is in `<dc_id>:<user_id>` format.
}
...
// WebAuthn registration response used when registering a new passkey
type InputPasskeyResponseRegister struct {
	ClientData      *DataJson // Base64url-decoded `clientDataJSON` field of an AuthenticatorAttestationResponse, wrapped in dataJSON
	AttestationData []byte    // Base64url-decoded `attestationObject` field of an AuthenticatorAttestationResponse
}
...
type InputRichMessageObj struct {
...
func (*InputRichMessageObj) CRC() uint32 {
	return 0xe4c449fc
}

func (*InputRichMessageObj) FlagIndex() int {
	return 0
}

func (*InputRichMessageObj) ImplementsInputRichMessage() {}
...
func (*InputRichMessageHtml) ImplementsInputRichMessage() {}
...
func (*InputRichMessageMarkdown) ImplementsInputRichMessage() {}
...
type InputStarGiftAuctionObj struct {
	GiftID int64 // Collectible gift ID
}
...
type JoinChatBotResult interface {
	tl.Object
	ImplementsJoinChatBotResult()
}
type JoinChatBotResultApproved struct{}

func (*JoinChatBotResultApproved) CRC() uint32 {
	return 0xae152a69
}

func (*JoinChatBotResultApproved) ImplementsJoinChatBotResult() {}

type JoinChatBotResultDeclined struct{}

func (*JoinChatBotResultDeclined) CRC() uint32 {
	return 0xefa0194
}

func (*JoinChatBotResultDeclined) ImplementsJoinChatBotResult() {}

type JoinChatBotResultQueued struct{}

func (*JoinChatBotResultQueued) CRC() uint32 {
	return 0x98a3a840
}

func (*JoinChatBotResultQueued) ImplementsJoinChatBotResult() {}

type JoinChatBotResultWebView struct {
	URL string
}

func (*JoinChatBotResultWebView) CRC() uint32 {
	return 0xd6e3b813
}
...
type MessageObj struct {
	...
	RichMessage             *RichMessage         `tl:"flag2:13"`
}
...
type MessageActionGiftCode struct {
	...
	Days           int32             // Duration of the gifted Telegram Premium subscription, in days.
...
func (*MessageActionManagedBotCreated) ImplementsMessageAction() {}
...
type MessageActionNewCreatorPending struct {
	NewCreatorID int64 // The ID of the user who will become the new owner of the group/channel after 7 days if the old owner does not rejoin.
}
...
type MessageActionNoForwardsRequest struct {
	Expired   bool `tl:"flag:0,encoded_in_bitflags"` // If set, this request was accepted or rejected by the other user and thus cannot be used anymore.
	PrevValue bool // Previous protection status.
	NewValue  bool // New requested protection status.
}

func (*MessageActionNoForwardsRequest) CRC() uint32 {
	return 0x3e2793ba
}

func (*MessageActionNoForwardsRequest) FlagIndex() int {
	return 0
}

func (*MessageActionNoForwardsRequest) ImplementsMessageAction() {}

// Emitted only in private chats when enabling or disabling content protection.
type MessageActionNoForwardsToggle struct {
	PrevValue bool // Previous protection status (if true, the chat was protected). May be equal to `new_value` when replying to requests
	NewValue  bool // New protection status.
}

func (*MessageActionNoForwardsToggle) CRC() uint32 {
	return 0xbf7d6572
}

func (*MessageActionNoForwardsToggle) ImplementsMessageAction() {}
...
func (*MessageActionPollDeleteAnswer) ImplementsMessageAction() {}
...
type MessageActionStarGift struct {
	...
	Saved              bool              `tl:"flag:2,encoded_in_bitflags"`  // Whether this gift was added to the destination user's profile (may be toggled using payments.saveStarGift and fetched using payments.getSavedStarGifts)
	...
	Upgraded           bool              `tl:"flag:5,encoded_in_bitflags"`  // This gift was upgraded to a collectible gift.
	Refunded           bool              `tl:"flag:9,encoded_in_bitflags"`  // This gift is not available anymore because a request to refund the payment related to this gift was made, and the money was returned.
	CanUpgrade         bool              `tl:"flag:10,encoded_in_bitflags"` // If set, this gift can be upgraded to a collectible gift; can only be set for the receiver of a gift.
	PrepaidUpgrade     bool              `tl:"flag:13,encoded_in_bitflags"` // The sender has already pre-paid for the upgrade of this gift to a collectible gift.
	UpgradeSeparate    bool              `tl:"flag:16,encoded_in_bitflags"` // This service message is the notification of a separate pre-payment for the upgrade of a gift we own.
	AuctionAcquired    bool              `tl:"flag:17,encoded_in_bitflags"` // If set, this gift was acquired in a collectible gifts auction.
	Gift               StarGift          // Info about the gift
	Message            *TextWithEntities `tl:"flag:1"`  // Additional message from the sender of the gift
	ConvertStars       int64             `tl:"flag:4"`  // The receiver of this gift may convert it to this many Telegram Stars, instead of displaying it on their profile page. `convert_stars` will be equal to `stars` only if the gift was bought using recently bought Telegram Stars, otherwise it will be less than `stars`.
	UpgradeMsgID       int32             `tl:"flag:5"`  // If set, this gift was upgraded to a collectible gift, and the corresponding messageActionStarGiftUnique is available at the specified message ID.
	UpgradeStars       int64             `tl:"flag:8"`  // The number of Telegram Stars the user can pay to convert the gift into a collectible gift.
	FromID             Peer              `tl:"flag:11"` // Sender of the gift (unset for anonymous gifts).
	Peer               Peer              `tl:"flag:12"` // Receiver of the gift.
...
// Contains an offer to purchase a collectible gift
type MessageActionStarGiftPurchaseOffer struct {
	Accepted  bool        `tl:"flag:0,encoded_in_bitflags"` // If set, the gift owner accepted this offer.
	Declined  bool        `tl:"flag:1,encoded_in_bitflags"` // If set, the gift owner declined this offer.
	Gift      StarGift    // The collectible gift the offer is about.
	Price     StarsAmount // Offered price.
	ExpiresAt int32       // Offer expiration date (UNIX timestamp): if the owner doesn't act before this date, the offer will expire and the buyer will be refunded automatically.
}
...
// A collectible gift purchase offer was declined, or the offer expired
type MessageActionStarGiftPurchaseOfferDeclined struct {
	Expired bool        `tl:"flag:0,encoded_in_bitflags"` // If set, the owner didn't act before the messageActionStarGiftPurchaseOffer.`expires_at` deadline and the offer expired automatically; otherwise, the owner explicitly declined the offer.
...
// A new birthday was suggested using users.suggestBirthday
...
// Represents an diff deletion: render it by simply <u>underlining</u> the specified section and coloring it in red
type MessageEntityDiffDelete struct {
	Offset int32 // Offset of message entity within message (in UTF-16 code units)
	Length int32 // Length of message entity within message (in UTF-16 code units)
}

func (*MessageEntityDiffDelete) CRC() uint32 {
	return 0x652c1c5
}

func (*MessageEntityDiffDelete) ImplementsMessageEntity() {}

// Represents an diff addition: render it by simply <u>underlining</u> the specified section and coloring it in green
type MessageEntityDiffInsert struct {
	Offset int32 // Offset of message entity within message (in UTF-16 code units)
	Length int32 // Length of message entity within message (in UTF-16 code units)
}

func (*MessageEntityDiffInsert) CRC() uint32 {
	return 0x71777116
}

func (*MessageEntityDiffInsert) ImplementsMessageEntity() {}

// Represents an diff replacement, render it as follows:
type MessageEntityDiffReplace struct {
	Offset  int32  // Offset of message entity within message (in UTF-16 code units)
	Length  int32  // Length of message entity within message (in UTF-16 code units)
	OldText string // The chunk of text that was removed.
}

func (*MessageEntityDiffReplace) CRC() uint32 {
	return 0xc6c1e5a7
}

func (*MessageEntityDiffReplace) ImplementsMessageEntity() {}
...
type MessageEntityFormattedDate struct {
	Relative  bool  `tl:"flag:0,encoded_in_bitflags"` // If set, render a relative date Cannot be combined with any of the other flags.
	ShortTime bool  `tl:"flag:1,encoded_in_bitflags"` // Renders the time in short format: hours and minutes, according to the user's locale settings; cannot be combined with `long_time`.
	LongTime  bool  `tl:"flag:2,encoded_in_bitflags"` // Renders the time in long format: hours, minutes, seconds and maybe timezone, according to the user's locale settings; cannot be combined with `short_time`.
	ShortDate bool  `tl:"flag:3,encoded_in_bitflags"` // Renders the time in short format: month, date, (and year, if different from the current one), all according the user's locale settings; cannot be combined with `long_date`.
	LongDate  bool  `tl:"flag:4,encoded_in_bitflags"` // Renders the time in long format: always month, date and year, all according the user's locale settings; cannot be combined with `short_date`.
	DayOfWeek bool  `tl:"flag:5,encoded_in_bitflags"` // Renders the day of the week according to the user's locale settings.
	Offset    int32 // Offset of message entity within message (in UTF-16 code units)
	Length    int32 // Length of message entity within message (in UTF-16 code units)
	Date      int32 // The date as a UNIX timestamp: the allowed value ranges from `0` to the current date plus 1098 days (`time()+1098*86400`).
}

func (*MessageEntityFormattedDate) CRC() uint32 {
	return 0x904ac7c7
}

func (*MessageEntityFormattedDate) FlagIndex() int {
	return 0
}

func (*MessageEntityFormattedDate) ImplementsMessageEntity() {}
...
func (*MessageMediaPoll) FlagIndex() int {
	return 0
}
...
type MessageReplyHeaderObj struct {
	...
	ReplyToEphemeral bool              `tl:"flag:13,encoded_in_bitflags"`
...
func (*InputMessagesFilterPoll) ImplementsMessagesFilter() {}
...
func (*InputPageBlockMap) CRC() uint32 {
	return 0x574b617f
}

func (*InputPageBlockMap) ImplementsPageBlock() {}
...
func (*PageBlockBlockquoteBlocks) CRC() uint32 {
	return 0xe6e47c4
}
...
func (*PageBlockHeading1) CRC() uint32 {
	return 0xbaff072f
}

func (*PageBlockHeading1) ImplementsPageBlock() {}

type PageBlockHeading2 struct {
	Text RichText
}

func (*PageBlockHeading2) CRC() uint32 {
	return 0x96b2aec
}

func (*PageBlockHeading2) ImplementsPageBlock() {}

type PageBlockHeading3 struct {
	Text RichText
}

func (*PageBlockHeading3) CRC() uint32 {
	return 0x67e731ad
}

func (*PageBlockHeading3) ImplementsPageBlock() {}

type PageBlockHeading4 struct {
	Text RichText
}

func (*PageBlockHeading4) CRC() uint32 {
	return 0xb532772b
}

func (*PageBlockHeading4) ImplementsPageBlock() {}

type PageBlockHeading5 struct {
	Text RichText
}

func (*PageBlockHeading5) CRC() uint32 {
	return 0xdbbe6c6a
}

func (*PageBlockHeading5) ImplementsPageBlock() {}

type PageBlockHeading6 struct {
	Text RichText
}

func (*PageBlockHeading6) CRC() uint32 {
	return 0x682a41a9
}

func (*PageBlockHeading6) ImplementsPageBlock() {}
...
func (*PageBlockMath) CRC() uint32 {
	return 0x59080c20
}

func (*PageBlockMath) ImplementsPageBlock() {}

// Ordered list of IV blocks
type PageBlockOrderedList struct {
	Reversed bool `tl:"flag:2,encoded_in_bitflags"`
	Items    []PageListOrderedItem
	Start    int32  `tl:"flag:0,explicit"`
	Type     string `tl:"flag:1"`
}
...
func (*PageBlockOrderedList) FlagIndex() int {
	return 0
}
...
func (*PageBlockThinking) CRC() uint32 {
	return 0x3c29a3e2
}

func (*PageBlockThinking) ImplementsPageBlock() {}
...
type PageListItemBlocks struct {
	Checkbox bool `tl:"flag:0,encoded_in_bitflags"`
	Checked  bool `tl:"flag:1,encoded_in_bitflags"`
	Blocks   []PageBlock
}
...
func (*PageListItemBlocks) FlagIndex() int {
	return 0
}
...
func (*PageListItemText) FlagIndex() int {
	return 0
}
...
type PageListOrderedItemBlocks struct {
	Checkbox bool   `tl:"flag:0,encoded_in_bitflags"`
	Checked  bool   `tl:"flag:1,encoded_in_bitflags"`
	Num      string `tl:"flag:2"`
	Blocks   []PageBlock
	Value    int32  `tl:"flag:3"`
	Type     string `tl:"flag:4"`
}
...
func (*PageListOrderedItemBlocks) FlagIndex() int {
	return 0
}
...
func (*PageListOrderedItemText) FlagIndex() int {
	return 0
}
...
// Represents a color palette associated to a collectible gift
type InputPeerColorCollectible struct {
	CollectibleID int64 // ID of the collectible gift.
}
...
type PeerColorCollectible struct {
	CollectibleID     int64   // ID of the collectible gift.
	GiftEmojiID       int64   // Custom emoji ID of the collectible gift: a single copy of this custom emoji should be displayed as-is (without recoloring it, unlike for `background_emoji_id`) in the top-right corner of the palette.
	BackgroundEmojiID int64   // Custom emoji ID used to generate the pattern.
	AccentColor       int32   // Accent color in RGB24 format, used for reply backgrounds and the user's name in messages.
	Colors            []int32 // 1-3 RGB24 colors to be used in the reply strip.
	DarkAccentColor   int32   `tl:"flag:0"` // Accent color in RGB24 format, used for reply backgrounds and the user's name in messages in dark mode (fallback to `accent_color` if absent).
	DarkColors        []int32 `tl:"flag:1"` // 1-3 RGB24 colors to be used in the reply strip in dark mode (fallback to `colors` if absent).
}
...
func (*InputPollAnswer) FlagIndex() int {
	return 0
}

func (*InputPollAnswer) ImplementsPollAnswer() {}
...
func (*PollAnswerObj) FlagIndex() int {
	return 0
}

func (*PollAnswerObj) ImplementsPollAnswer() {}
...
func (*RequestPeerTypeCreateBot) FlagIndex() int {
	return 0
}

func (*RequestPeerTypeCreateBot) ImplementsRequestPeerType() {}
...
func (*TextAutoEmail) CRC() uint32 {
	return 0xc556a45d
}

func (*TextAutoEmail) ImplementsRichText() {}

type TextAutoPhone struct {
	Text RichText
}

func (*TextAutoPhone) CRC() uint32 {
	return 0x24c26789
}

func (*TextAutoPhone) ImplementsRichText() {}

type TextAutoURL struct {
	Text RichText
}

func (*TextAutoURL) CRC() uint32 {
	return 0xac6a83aa
}

func (*TextAutoURL) ImplementsRichText() {}

type TextBankCard struct {
	Text RichText
}

func (*TextBankCard) CRC() uint32 {
	return 0xb956812d
}

func (*TextBankCard) ImplementsRichText() {}
...
func (*TextBotCommand) CRC() uint32 {
	return 0x2ff29d3
}
...
func (*TextCashtag) CRC() uint32 {
	return 0x7b9e1801
}

func (*TextCashtag) ImplementsRichText() {}
...
func (*TextCustomEmoji) CRC() uint32 {
	return 0xa26156c0
}

func (*TextCustomEmoji) ImplementsRichText() {}

type TextDate struct {
	Relative  bool `tl:"flag:0,encoded_in_bitflags"`
	ShortTime bool `tl:"flag:1,encoded_in_bitflags"`
	LongTime  bool `tl:"flag:2,encoded_in_bitflags"`
	ShortDate bool `tl:"flag:3,encoded_in_bitflags"`
	LongDate  bool `tl:"flag:4,encoded_in_bitflags"`
	DayOfWeek bool `tl:"flag:5,encoded_in_bitflags"`
	Text      RichText
	Date      int32
}

func (*TextDate) CRC() uint32 {
	return 0xa5b45e2b
}

func (*TextDate) FlagIndex() int {
	return 0
}
...
func (*TextHashtag) CRC() uint32 {
	return 0x519524ea
}

func (*TextHashtag) ImplementsRichText() {}
...
func (*TextMath) CRC() uint32 {
	return 0x9d2eac97
}

func (*TextMath) ImplementsRichText() {}

type TextMention struct {
	Text RichText
}

func (*TextMention) CRC() uint32 {
	return 0xcd24cf44
}

func (*TextMention) ImplementsRichText() {}
...
func (*TextMentionName) CRC() uint32 {
	return 0x1a9fbfc
}

func (*TextMentionName) ImplementsRichText() {}
...
func (*TextSpoiler) CRC() uint32 {
	return 0x4c2a5d62
}

func (*TextSpoiler) ImplementsRichText() {}
...
type StarGiftObj struct {
	Limited             bool                `tl:"flag:0,encoded_in_bitflags"`  // Whether this is a limited-supply gift.
	SoldOut             bool                `tl:"flag:1,encoded_in_bitflags"`  // Whether this gift sold out and cannot be bought anymore.
	Birthday            bool                `tl:"flag:2,encoded_in_bitflags"`  // Whether this is a birthday-themed gift
	RequirePremium      bool                `tl:"flag:7,encoded_in_bitflags"`  // This gift can only be bought by users with a Premium subscription.
	LimitedPerUser      bool                `tl:"flag:8,encoded_in_bitflags"`  // If set, the maximum number of gifts of this type that can be owned by a single user is limited and specified in `per_user_total`, and the remaining slots for the current user in `per_user_remains`.
	PeerColorAvailable  bool                `tl:"flag:10,encoded_in_bitflags"` // If set, collectible gifts of this type may be used to generate a message color palette and pattern.
	Auction             bool                `tl:"flag:11,encoded_in_bitflags"` // If set, this is a collectible gift that can only be bought through a collectible gift auction.
	ID                  int64               // Identifier of the gift
	Sticker             Document            // Sticker that represents the gift.
	Stars               int64               // Price of the gift in Telegram Stars.
	AvailabilityRemains int32               `tl:"flag:0"` // For limited-supply gifts: the remaining number of gifts that may be bought.
	AvailabilityTotal   int32               `tl:"flag:0"` // For limited-supply gifts: the total number of gifts that was available in the initial supply.
	AvailabilityResale  int64               `tl:"flag:4"` // The total number of (upgraded to collectibles) gifts of this type currently on resale
	...
	FirstSaleDate       int32               `tl:"flag:1"`  // For sold out gifts only: when was the gift first bought.
	LastSaleDate        int32               `tl:"flag:1"`  // For sold out gifts only: when was the gift last bought.
	UpgradeStars        int64               `tl:"flag:3"`  // The number of Telegram Stars the user can pay to convert the gift into a collectible gift.
	ResellMinStars      int64               `tl:"flag:4"`  // The minimum price in Stars for gifts of this type currently on resale.
	Title               string              `tl:"flag:5"`  // Title of the gift
	ReleasedBy          Peer                `tl:"flag:6"`  // This gift was released by the specified peer.
	PerUserTotal        int32               `tl:"flag:8"`  // Maximum number of gifts of this type that can be owned by any user.
	PerUserRemains      int32               `tl:"flag:8"`  // Remaining number of gifts of this type that can be owned by the current user.
	LockedUntilDate     int32               `tl:"flag:9"`  // If set, the specified gift <em>possibly</em> cannot be sent until the specified date
	AuctionSlug         string              `tl:"flag:11"` // Always set for gifts that can be bought on auctions, contains the auction deep link slug.
	GiftsPerRound       int32               `tl:"flag:11"` // Always set for gifts that can be bought on auctions, contains the number of gifts of this kind that are distributed on every round.
	AuctionStartDate    int32               `tl:"flag:11"` // Always set for gifts that can be bought on auctions, contains the UNIX timestamp indicating when will the auction start (or when the auction started, if it points to the past).
	UpgradeVariants     int32               `tl:"flag:12"` // Total number of possible collectible variants for this gift type.
	Background          *StarGiftBackground `tl:"flag:13"` // Default background palette for this gift type, used when rendering gift cards and previews before a specific collectible backdrop is chosen.
}
...
type StarGiftUnique struct {
	...
	ID                  int64               // Unique identifier of this collectible gift.
	GiftID              int64               // ID of the regular gift from which this gift was upgraded (all collectible gifts upgraded from the same gift will have the same `gift_id`, with different attributes).
	...
	Num                 int32               // Unique identifier of this collectible gift among all (already upgraded) collectible gifts of the same type.
	OwnerID             Peer                `tl:"flag:0"` // The owner of the gift.
	OwnerName           string              `tl:"flag:1"` // The name of the owner if neither `owner_id` nor `owner_address` are set.
	OwnerAddress        string              `tl:"flag:2"` // For NFTs on the TON blockchain, contains the address of the owner (append it to the ton_blockchain_explorer_url client configuration value to obtain a link with information about the address).
	Attributes          []StarGiftAttribute // Collectible attributes
	AvailabilityIssued  int32               // Total number of gifts of the same type that were upgraded to a collectible gift.
	AvailabilityTotal   int32               // Total number of gifts of the same type that can be upgraded or were already upgraded to a collectible gift.
	GiftAddress         string              `tl:"flag:3"`  // For NFTs on the TON blockchain, contains the address of the NFT (append it to the ton_blockchain_explorer_url client configuration value to obtain a link with information about the address).
	ResellAmount        []StarsAmount       `tl:"flag:4"`  // Resale price of the gift.
	ReleasedBy          Peer                `tl:"flag:5"`  // This gift was released by the specified peer.
	ValueAmount         int64               `tl:"flag:8"`  // Estimated price of the gift.
	ValueCurrency       string              `tl:"flag:8"`  // Currency for the gift's estimated price.
...
type StarGiftAttributeBackdrop struct {
	...
	Rarity       StarGiftAttributeRarity // Rarity of this backdrop.
}
...
type StarGiftAttributeModel struct {
	Crafted  bool                    `tl:"flag:0,encoded_in_bitflags"` // This model is reserved for crafting, and should be filtered out from regular upgrade previews.
...
type StarGiftAttributeRarityObj struct {
	Permille int32 // Probability of this attribute, in permille
}
...
type StarGiftAuctionRoundObj struct {
	Num      int32 // This object describes all rounds starting from `num` up until `next.num-1` inclusively (`next` is the next StarGiftAuctionRound).
	Duration int32 // Duration in seconds of the round(s).
}
...
type StarGiftAuctionRoundExtendable struct {
	Num          int32 // This object describes all rounds starting from `num` up until `next.num-1` inclusively (`next` is the next StarGiftAuctionRound).
	Duration     int32 // Duration in seconds of the round(s).
	ExtendTop    int32 // The round(s) will be extended by `extend_window` if a bid changes the composition/order of the top `extend_top` bidders.
	ExtendWindow int32 // The round(s) will be extended by this many seconds if a bid changes the composition/order of the top `extend_top` bidders.
}
...
type StarGiftAuctionStateObj struct {
	Version      int32                  // Only apply incoming starGiftAuctionState constructors if the received `version` is bigger than the locally cached `version`.
	StartDate    int32                  // UNIX timestamp indicating when the auction will start (or when it started, if it's in the past).
	EndDate      int32                  // UNIX timestamp indicating when the auction will end
	MinBidAmount int64                  // Minumum allowed bid amount in Telegram Stars: only applicable if the user hasn't made a bid yet, otherwise must be overridden to the value of starGiftAuctionUserState.`min_bid_amount` (which will be set if and only if the user already made a bid to this auction).
	BidLevels    []*AuctionBidLevel     // Contains a sparse list of bids starting from the top bids, a more detailed description is available in the docs.
	TopBidders   []int64                // User IDs of the top 3 bidders (the user constructors will be returned as min constructors in the containing object).
	NextRoundAt  int32                  // UNIX timestamp indicating when the current auction round will end, distributing starGift.`gifts_per_round` gifts to the top starGift.`gifts_per_round` bidders.
	LastGiftNum  int32                  // The number of gifts that were distributed in the previous round (also used to compute the approximated index of the gift that the current user will receive, `last_gift_num + approx_pos`
	GiftsLeft    int32                  // The remaining number of gifts that are yet to be distributed.
	CurrentRound int32                  // The current round number (starting from 1).
	TotalRounds  int32                  // The total number of rounds in this auction.
	Rounds       []StarGiftAuctionRound // Detailed round information.
}
...
type StarGiftAuctionStateFinished struct {
	StartDate           int32  // UNIX timestamp indicating when the auction started.
	EndDate             int32  // UNIX timestamp indicating when the auction ended.
	AveragePrice        int64  // Average price of distributed gifts.
	ListedCount         int32  `tl:"flag:0"` // Number of gifts from the auction currently being resold on Telegram: if set, when the corresponding element is clicked in graphical clients, payments.getResaleStarGifts should be invoked with the ID of the gift associated to this auction
	FragmentListedCount int32  `tl:"flag:1"` // Number of gifts from the auction currently being resold on Fragment.
	FragmentListedURL   string `tl:"flag:1"` // Only set if `fragment_listed_count` is set. If set, when the corresponding element is clicked in graphical clients, this URL should be opened.
}
...
type StarsAmountObj struct {
	...
	Nanos  int32 // The decimal amount of Telegram Stars, expressed as nanostars (i.e. 1 nanostar is equal to `1/1_000_000_000`th (one billionth) of a Telegram Star). This field may also be negative (the allowed range is from `-999_999_999` to `999_999_999`).
}
...
func (*UpdateAiComposeTones) ImplementsUpdate() {}
...
func (*UpdateBotChatInviteRequester) FlagIndex() int {
	return 0
}
...
func (*UpdateBotGuestChatQuery) FlagIndex() int {
	return 0
}

func (*UpdateBotGuestChatQuery) ImplementsUpdate() {}
...
type UpdateChatDefaultBannedRights struct {
	...
	Version             int32             // Used similarly to `pts` values to deduplicate/update outdated chat information as specified here.
}
...
type UpdateChatParticipantRank struct {
	ChatID  int64  // Basic group ID.
	UserID  int64  // User ID.
	Rank    string // The new tag.
	Version int32  // Used similarly to `pts` values to deduplicate/update outdated chat information as specified here.
}

func (*UpdateChatParticipantRank) CRC() uint32 {
	return 0xbd8367b9
}

func (*UpdateChatParticipantRank) ImplementsUpdate() {}
...
func (*UpdateJoinChatWebViewDecision) CRC() uint32 {
	return 0xbdac7e70
}

func (*UpdateJoinChatWebViewDecision) ImplementsUpdate() {}
...
func (*UpdateManagedBot) ImplementsUpdate() {}
...
type UpdateNewBotConnection struct {
	Confirmed bool `tl:"flag:0,encoded_in_bitflags"`
	BotID     int64
	Date      int32  `tl:"flag:1"`
	Device    string `tl:"flag:1"`
	Location  string `tl:"flag:1"`
}

func (*UpdateNewBotConnection) CRC() uint32 {
	return 0xb22083a6
}

func (*UpdateNewBotConnection) FlagIndex() int {
	return 0
}

func (*UpdateNewBotConnection) ImplementsUpdate() {}
...
type UpdateReadHistoryInbox struct {
	FolderID         int32 `tl:"flag:0"` // Peer folder ID, for more info click here
	Peer             Peer  // Peer
	TopMsgID         int32 `tl:"flag:1"` // If set, the messages were read only within the specified bot forum topic.
...
// Contains updates to auction state
type UpdateStarGiftAuctionState struct {
	GiftID int64                // ID of the collectible gift currently being distributed in the auction.
...
// Contains updates to auction state related to the current user
...
type UpdateUserTyping struct {
	UserID   int64             // User id
	TopMsgID int32             `tl:"flag:0"` // If set, this notification was sent within a bot forum topic.
...
func (*UpdateWebBrowserException) CRC() uint32 {
	return 0x140502d1
}

func (*UpdateWebBrowserException) FlagIndex() int {
	return 0
}

func (*UpdateWebBrowserException) ImplementsUpdate() {}
...
func (*UpdateWebBrowserSettings) CRC() uint32 {
	return 0xc39a2ade
}

func (*UpdateWebBrowserSettings) FlagIndex() int {
	return 0
}

func (*UpdateWebBrowserSettings) ImplementsUpdate() {}
...
type URLAuthResultAccepted struct {
	URL string `tl:"flag:0"` // If present, the URL to open in the external browser (may use a custom scheme for direct switching to another app); if absent, the login succeeded and clients should simply show a confirmation toast. Always set for bot button URL authorization and link URL authorization.
}
...
type URLAuthResultRequest struct {
	...
	RequestPhoneNumber bool     `tl:"flag:1,encoded_in_bitflags"` // The app/website is requesting the user's phone number; if the user consents, set `share_phone_number` when calling messages.acceptUrlAuth
	MatchCodesFirst    bool     `tl:"flag:5,encoded_in_bitflags"` // Can only be set if `match_codes` is also set; if set, clients must ask the user to select the matching code <em>before</em> showing the rest of the login confirmation UI, and must validate the selection with messages.checkUrlAuthMatchCode before proceeding
	IsApp              bool     `tl:"flag:6,encoded_in_bitflags"` // Set if an OAuth request originated from an app rather than a website; when set, `domain` must be replaced in the confirmation prompt by `verified_app_name` (if present) or "Unverified App"
	...
	Browser            string   `tl:"flag:2"` // The browser the user used to make the OAuth request
	Platform           string   `tl:"flag:2"` // The platform (operating system) of the user that made the OAuth request
	Ip                 string   `tl:"flag:2"` // The IP address of the user making the OAuth request
	Region             string   `tl:"flag:2"` // The location of the user, inferred from the IP address
	MatchCodes         []string `tl:"flag:3"` // A list of emojis or codes, one of which is currently being shown on the login page of the website/app; the user must select the matching one and pass it to messages.acceptUrlAuth.`match_code`
	UserIDHint         int64    `tl:"flag:4"` // May contain the ID of the account for which the login request was created; if it matches a logged-in account, clients should automatically switch to that account and re-invoke messages.requestUrlAuth before showing the prompt
	VerifiedAppName    string   `tl:"flag:7"` // Can only be set if `is_app` is set and the app is verified; must replace `domain` in the confirmation prompt when present
}
...
type UserObj struct {
	...
	BotCanManageBots        bool `tl:"flag2:18,encoded_in_bitflags"`
	BotGuestchat            bool `tl:"flag2:19,encoded_in_bitflags"`
	BotGuard                bool `tl:"flag2:20,encoded_in_bitflags"`
	ID                      int64
...
func (*WebPageAttributeAiComposeTone) ImplementsWebPageAttribute() {}
...
type WebPageAttributeStarGiftAuction struct {
	...
	EndDate int32    // Date when the auction will end (UNIX timestamp)
}
...
type AccountWebBrowserSettings interface {
	tl.Object
	ImplementsAccountWebBrowserSettings()
}
type AccountWebBrowserSettingsObj struct {
	OpenExternalBrowser bool `tl:"flag:0,encoded_in_bitflags"`
	DisplayCloseButton  bool `tl:"flag:1,encoded_in_bitflags"`
...
func (*AccountWebBrowserSettingsObj) CRC() uint32 {
	return 0x79eb8cb3
}

func (*AccountWebBrowserSettingsObj) FlagIndex() int {
	return 0
}

func (*AccountWebBrowserSettingsObj) ImplementsAccountWebBrowserSettings() {}

type AccountWebBrowserSettingsNotModified struct{}

func (*AccountWebBrowserSettingsNotModified) CRC() uint32 {
	return 0xc31c8f4e
}

func (*AccountWebBrowserSettingsNotModified) ImplementsAccountWebBrowserSettings() {}

type AicomposeTones interface {
	tl.Object
...
func (*AicomposeTonesNotModified) ImplementsAicomposeTones() {}
...
type MessagesChatInviteJoinResult interface {
	tl.Object
	ImplementsMessagesChatInviteJoinResult()
}
type MessagesChatInviteJoinResultOk struct {
	Updates Updates
}

func (*MessagesChatInviteJoinResultOk) CRC() uint32 {
	return 0x445663a7
}

func (*MessagesChatInviteJoinResultOk) ImplementsMessagesChatInviteJoinResult() {}
...
type PaymentsStarGiftActiveAuctionsObj struct {
	Auctions []*StarGiftActiveAuctionState // Auctions where the user has placed a bid
	Users    []User                        // Mentioned users
	Chats    []Chat                        // Mentioned chats
}
...
type UpdatesChannelDifferenceTooLong struct {
	Final    bool      `tl:"flag:0,encoded_in_bitflags"` // Whether there are more updates that must be fetched (always set)
	...
	Messages []Message // The latest messages (not starting from the passed `pts`, just the latest messages).
